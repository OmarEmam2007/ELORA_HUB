...
const MONSTERS = {
    ...
    moss_wolf: {
        ...
        skills: [{ id: 'bite', nameAr: 'عضّة', chance: 0.25, mult: 1.35 }],
        learnWeight: 0.08
    },
    ash_slime: {
        id: 'ash_slime',
        ...
        skills: [{ id: 'spit', nameAr: 'بصقة حامضية', chance: 0.2, effect: 'burn', turns: 2 }],
        learnWeight: 0.06
    },
    elder_wisp: {
        id: 'elder_wisp',
        ...
        skills: [
            { id: 'flare', nameAr: 'وهج', chance: 0.35, mult: 1.5, effect: 'burn', turns: 2 },
            { id: 'fear', nameAr: 'رعب قديم', chance: 0.2, effect: 'fear', turns: 1 }
        ],
        isBoss: true,
        learnWeight: 0.12
    },
    bone_hound: {
        ...
        skills: [{ id: 'howl', nameAr: 'عواء', chance: 0.2, effect: 'fear', turns: 1 }],
        learnWeight: 0.1
    },
    grave_scarab: {
        id: 'grave_scarab',
        ...
        skills: [{ id: 'sting', nameAr: 'لسعة', chance: 0.3, effect: 'poison', turns: 3 }],
        learnWeight: 0.1
    },
    hollow_knight: {
        id: 'hollow_knight',
        ...
        skills: [{ id: 'cleave', nameAr: 'شقّ', chance: 0.35, mult: 1.6 }],
        isBoss: true,
        learnWeight: 0.15
    },
    shadow_leech: {
        ...
        skills: [{ id: 'drain', nameAr: 'امتصاص', chance: 0.3, mult: 1.2, healSelf: 0.4 }],
        learnWeight: 0.12
    },
    eclipse_hydra: {
        id: 'eclipse_hydra',
        ...
        skills: [{ id: 'triple_bite', nameAr: 'عضّات ثلاث', chance: 0.4, mult: 1.8 }],
        isBoss: true,
        learnWeight: 0.2
    }
};
